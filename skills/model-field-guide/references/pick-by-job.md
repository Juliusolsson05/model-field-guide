...
- **Check:** `tables/coding.md`, then `tables/price-context.md`
...
- **Check:** `tables/overall.md` (ECI), `tables/agents.md`
...
- **Check:** `tables/computer-use.md` (independent Epoch rows first, Steel vendor-reported rows second)
...
- **Check:** `tables/overall.md` (LMArena text + ECI)
...
- **Check:** `tables/price-context.md`, then `tables/agents.md`
...
- **Check:** `tables/price-context.md` (open-weights flag), `tables/coding.md`
...
- **Effort:** default
- **Check:** `tables/coding.md` (LMArena webdev)
...
- **Check:** `tables/price-context.md` (context and output limits)
...
- **Check:** `tables/overall.md` (LMArena search, where available)
...
- **Check:** `tables/agents.md`, `tables/price-context.md`
